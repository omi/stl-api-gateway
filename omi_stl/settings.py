"""
Django settings for omi_stl project.
...
SECRET_KEY = '8-@oc@uc-&5)&1l)kzwt0o-zh#vtws(1xo)_%y!f%(6142zp8j'
...
WSGI_APPLICATION = 'omi_stl.wsgi.application'
